...
public class TooltipBase : MonoBehaviour
{
    ...
    //private void Adjust()
    //{
    //    float tooltipRectOffset = viewData.offset;//整体偏移
    ...
    //            tooltipRectOffset += tooltipRect.rect.height / 2;
    //            if (showArrow)
    //            {
    //                tooltipRectOffset += arrowRect.rect.height / 2;
    ...
    //            }
    //            tooltipRect.localPosition += Vector3.up * tooltipRectOffset;
    //            break;
    ...
    //            }
    //            tooltipRect.localPosition += Vector3.down * tooltipRectOffset;
    //            break;
    //        case ETooltipDirType.Left:
    //            tooltipRectOffset += tooltipRect.rect.width / 2;
    //            if (showArrow)
    //            {
    //                tooltipRectOffset += arrowRect.rect.width / 2;
    ...
    //            }
    //            tooltipRect.localPosition += Vector3.left * tooltipRectOffset;
    //            break;
    ...
    //                arrowRect.eulerAngles = new Vector3(0, 0, -90);
    //            }
    //            tooltipRect.localPosition += Vector3.right * tooltipRectOffset;
    //            break;
    //        default:
    //            break;
    //    }
